...
document.addEventListener("turbolinks:load", function(e) {
	if (checkHandle(e)) {
		...
		var flagAdd = false;
		document.querySelectorAll('[data-add]').forEach( function(element, index) {
			element.addEventListener('click', function(e) {
				e.preventDefault();
				if (checkHandle(e) && !flagAdd) {
					flagAdd = true;
		...
		function deleteDataUser() {
			document.querySelectorAll('[data-delete]').forEach( function(element, index) {
				element.addEventListener('click', function(e){
					e.preventDefault();
					var self = this;
